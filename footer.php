	...
	<footer>
		...
		<section id="share" class="content">
			<div id="facebook">
				...
				<div class="fb-like" data-href="http://ageomatic.co" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true"></div>
			</div>
			<div id="tell">Want to Share?</div>
			<div id="twitter">
				<?php if($_GET) { ?>
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://ageomatic.co" data-text="#ageomatic tells me <?php echo $name; ?> is <?php echo $bday->age($now, $in, $secsIn); ?> old." data-via="ageomatic">Tweet</a>
				<?php } else { ?>
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://ageomatic.co" data-text="Find out how old you are with the #ageomatic" data-via="ageomatic">Tweet</a>
				<?php } ?>
